...
const FAM_DATA = [
  ...
  // ── ACTIVITIES · RIYADH ──
  {
    ...
    prayer: true,
    score: 4.6,
    crowd: 'Severe Peak on Weekends',
    stroller: true,
    parking: 'Ample Mall Parking',
    dining: 'On-Site Cafe & Snacks',
    desc: 'An incredible indoor trampoline haven. It features a fully separate, private arena exclusively for girls and women, alongside the main family jump sections. Outstanding for burning off intense energy when the summer heat hits.',
  ...
  },
  {
    ...
    prayer: true,
    score: 4.8,
    crowd: 'Moderate Afternoons',
    stroller: true,
    parking: 'Riyadh Park Parking',
    dining: 'Full Food Court Attached',
    desc: 'A massive indoor mini-city where kids roleplay real-world professions and earn currency. Fully air-conditioned, highly secure, and deeply educational — perfect for an entire weekend afternoon tracking escape from the heat.',
  ...
  },
  {
    ...
    prayer: true,
    score: 4.3,
    crowd: 'High Peak on Friday Nights',
    stroller: false,
    parking: 'Valet & Mall Spaces',
    dining: 'Fast Food Links Nearby',
    desc: 'A high-octane indoor amusement hub featuring virtual reality setups, major thrill rides, and premium bowling alleys designed specifically to keep hard-to-please pre-teens and teenagers thoroughly engaged.',
    url: '#'
  },
  ...
  // ── ACTIVITIES · JEDDAH ──
  {
    ...
    prayer: true,
    score: 4.5,
    crowd: 'Very Busy Post-7PM',
    stroller: true,
    parking: 'Dedicated On-Site Lot',
    dining: 'Theme Park Dining & Kiosks',
    desc: 'Jeddah\'s iconic landmark theme park right on the Corniche. It features a large indoor ice rink and arcade zones alongside massive outdoor rollercoasters. Pro tip: Arrive after 5:00 PM as the Red Sea breeze cools the park down.',
    url: '#'
  },
  {
    id: 'corniche',
    ...
    prayer: true,
    score: 4.7,
    crowd: 'High Weekend Crowds',
    stroller: true,
    parking: 'Corniche Public Bays',
    dining: 'Endless Cafes & Ice Cream',
    desc: 'A stunning 30km open promenade offering dedicated safe bike rental tracks, ocean-facing playgrounds, and family picnic lawns. Completely free and highly popular for breezy evening family walks.',
  ...
  },
  {
    ...
    section: 'activities',
    subcat: 'camp',
    name: 'Fakieh Aquarium & Camp Sessions',
    logo: 'FA',
    lc: '#1A4A7A',
    indoor: true,
    ageRange: '2 – 16 Years',
    prayer: true,
    score: 4.6,
    crowd: 'Moderate Weekend Peaks',
    stroller: true,
    parking: 'On-Site Parking Lot',
    dining: 'Seafood Restaurant On-Site',
    desc: 'The premier public aquarium in the Kingdom, displaying beautiful Red Sea marine wildlife. They run fantastic, structured indoor educational camps and dolphin shows during school holiday breaks.',
    url: '#'
  },
  ...
  // ── ACTIVITIES · EASTERN PROVINCE ──
  {
    ...
    prayer: true,
    score: 4.7,
    crowd: 'High Evening Rush',
    stroller: true,
    parking: 'Al Rashid Mall Parking',
    dining: 'In-Mall Dining Access',
  ...
  },
  {
    ...
    prayer: true,
    score: 4.5,
    crowd: 'Booking Mandatory',
    stroller: false,
    parking: 'Private Facility Lots',
    dining: 'Snack Bar & Lounge',
    desc: 'An indoor multi-level electric go-karting track running youth racing academies and safe corporate-style time trials. Great coaching staff, safety gear provided, and entirely air-conditioned.',
    url: '#'
  },
  {
    id: 'scitech-ep',
    ...
    prayer: true,
    score: 4.6,
    crowd: 'School Group Peaks Morning',
    stroller: true,
    parking: 'Massive Front Lot',
    dining: 'Snack Kiosks & Vending',
